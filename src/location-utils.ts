...
//  */
// export function calculateLocationDistance(location1: LocationData, location2: LocationData): number {
...
//  */
// export function calculateDistanceAndBearing(location1: LocationData, location2: LocationData): DistanceCalculation {
...
//  */
// export function isSameCountry(location1: LocationData, location2: LocationData): boolean {
...
//  */
// export function isSameRegion(location1: LocationData, location2: LocationData): boolean {
//   return location1.countryCode === location2.countryCode &&
...
//   if (isSameCountry(currentLocation, previousLocation) && distance > distanceThreshold * 0.5) {
//     return {
//       suspicious: true,
