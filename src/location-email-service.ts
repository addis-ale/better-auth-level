...
// import { getDistanceDescription, getBearingDescription } from './location-utils';
...
//       ? `${process.env.APP_URL || 'http://localhost:3000'}/auth/verify-location?token=${verificationToken}`
//       : '#';
...
//             Math.pow(currentLocation.longitude - previousLocation.longitude, 2)
...
//               <li><strong>Location:</strong> ${currentLocation.city}, ${currentLocation.region}, ${currentLocation.country}</li>
//               <li><strong>IP Address:</strong> ${currentLocation.ip}</li>
//               <li><strong>Time:</strong> ${new Date(currentLocation.timestamp).toLocaleString()}</li>
...
//             <ul style="margin: 0; padding-left: 20px;">
//               <li><strong>Location:</strong> ${previousLocation.city}, ${previousLocation.region}, ${previousLocation.country}</li>
//               <li><strong>Time:</strong> ${new Date(previousLocation.timestamp).toLocaleString()}</li>
...
//               <li><strong>IP Address:</strong> ${location.ip}</li>
//               <li><strong>Time:</strong> ${new Date(location.timestamp).toLocaleString()}</li>
//               <li><strong>Confidence:</strong> ${Math.round(suspiciousEvent.confidence * 100)}%</li>
//             </ul>
//           </div>
